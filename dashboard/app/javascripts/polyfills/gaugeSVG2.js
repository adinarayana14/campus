...
GaugeSVG = function (params) {
    ...
    this.config = {
        ...
        labelColor: (params.labelColor != undefined) ? params.labelColor : "#000000",
        ...
        gaugeBorderColor: (params.gaugeBorderColor != undefined) ? params.gaugeBorderColor : "#E9EDEB",
        ...
        gaugeBackColor: (params.gaugeBackColor != undefined) ? params.gaugeBackColor : "#E9EDEB",
        ...
        gaugeShadowScale: (params.gaugeShadowScale != undefined) ? params.gaugeShadowScale : 0.5,
        ...
        needleColor: (params.needleColor != undefined) ? params.needleColor : "#000000",

        // The optimum range color. Default is "#44ff44".
        optimumRangeColor: (params.optimumRangeColor != undefined) ? params.optimumRangeColor : "#449d44",

        // The warning range color. Default is "#ffff00".
        warningRangeColor: (params.warningRangeColor != undefined) ? params.warningRangeColor : "#f9c802",

        // The action range color. Default is "#ff4444".
        actionRangeColor: (params.actionRangeColor != undefined) ? params.actionRangeColor : "#ff0000",

        //unit of the guage
        unit: (params.unit != undefined) ? params.unit : '',
    };
    ...
    if (this.config.title && this.config.title != "") {
        ...
        this.gaugeTIT.setAttributeNS(null, 'style', "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 9) + "px; font-weight:bold; fill-opacity:1.0; fill:" + this.config.titleColor + "; text-anchor:middle;");
    ...
    if (this.config.label && this.config.label != "") {
        ...
        this.gaugeLBL.setAttributeNS(null, 'style', "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 17) + "px; font-weight:normal; fill-opacity:1.0; fill:" + this.config.labelColor + "; text-anchor:middle;");
    ...
    //switch(params.title) {
    //    case  document.getElementById("guage1Title").innerHTML.replace('<font>', '').replace('</font>', '').replace('<font>', '').replace('</font>', ''):
    //        unit = '%';
    //        break;
    //    case  document.getElementById("guage2Title").innerHTML.replace('<font>', '').replace('</font>', '').replace('<font>', '').replace('</font>', ''):
    //        unit = 'v';
    //        break;
    //    case document.getElementById("guage3Title").innerHTML.replace('<font>', '').replace('</font>', '').replace('<font>', '').replace('</font>', ''):
    //        unit = '';
    //        break;
    //    case document.getElementById("guage4Title").innerHTML.replace('<font>', '').replace('</font>', '').replace('<font>', '').replace('</font>', ''):
    //        unit = String.fromCharCode(parseInt('B0', 16)) +'F';
    //        break;
    //}
    this.gaugeVAL.appendChild(document.createTextNode(Math.round(this.config.originalValue) + this.config.unit));
    ...
    if (this.config.showMinMax == true) {
        ...
        this.gaugeMAX.setAttributeNS(null, 'y', this.config.offsetY + this.config.canvasH / 1.01);
        this.gaugeMAX.setAttributeNS(null, 'style', "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 11) + "px; font-weight:normal; fill-opacity:1.0;   fill:" + this.config.minmaxColor + "; text-anchor:middle;");
    ...
    if (this.config.showMinMax == true) {
        ...
        this.gaugeMIN.setAttributeNS(null, 'y', this.config.offsetY + this.config.canvasH / 1.01);
        this.gaugeMIN.setAttributeNS(null, 'style', "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 11) + "px; font-weight:normal; fill-opacity:1.0; fill:" + this.config.minmaxColor + "; text-anchor:middle;");
    ...
    this.refresh = function (valueNew, animated) {
        ...
        if (this.config.value == '' || this.config.value == null || this.config.value == undefined) {
            this.gaugeVAL.childNodes[0].textContent = document.getElementById("noData").innerHTML.replace('<font>', '').replace('</font>', '').replace('<font>', '').replace('</font>', '');
            animated = false;
        }
        else {
            this.gaugeVAL.childNodes[0].textContent = this.config.value + this.config.unit;
        }
        if (animated == true) {
